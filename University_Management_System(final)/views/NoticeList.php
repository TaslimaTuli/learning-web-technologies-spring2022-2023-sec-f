    ...
    <ul>
        ...
        <li> <a href="../controllers/logout.php">Logout</a> </li>
                ...
                <table>
                        ...
                        <tr>
                            <td><a href="NoticeAdd.php">Add New Notice</a>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <th width="45%">Notice Description</th>
                            <th width="15%">Date</th>
                            <th>Operations</th>
                        </tr>   
                        <tr>
                          <tr>
                                <?php while($row = mysqli_fetch_assoc($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                        <!-- <a href="../controllers/noticeDeleteCheck.php?id=<?php echo $row['id']; ?>">Delete</a> -->
                ...
                btn.addEventListener('click', function() {
                    ...
                    xhttp.open('POST', '../controllers/noticeDeleteCheck.php', true);
